...
dojo.declare("js.config", null, {
    ...
    ApplicationName: "Address Crowdsourcing",

    // Set application icon path
    ApplicationIcon: "images/applicationImg.png",

    // Set splash window content - Message that appears when the application starts
    SplashScreenMessage: "<b>Address Crowdsourcing</b> <br/> <hr/> <br/>The <b>Address Crowdsourcing</b> application allows the general public to contribute missing site address locations and provide contact information for current addresses. It is used to enlist citizens and members of the general public in the continuous improvement of address and contact information across our community.<br/><br/>",
